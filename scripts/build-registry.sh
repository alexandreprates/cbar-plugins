...
add_plugin "network.ssh-hosts" "SSH Hosts" "network" "Shows configured SSH host reachability with compact status." "1.1.0" "plugins/network/ssh-hosts.30s.sh" "30s" "bash" "en" "awk,base64,date,ssh,tr,wl-copy,xclip" "CBAR_SSH_HOSTS,CBAR_SSH_WARN_MS,CBAR_SSH_TIMEOUT" "GPL-3.0-only" "AlexandrePrates" "https://github.com/AlexandrePrates"
